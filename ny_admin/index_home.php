...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="assets/H+/css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
    <link href="assets/H+/css/font-awesome.min93e3.css?v=4.4.0" rel="stylesheet">

    <!-- Morris -->
    <link href="assets/H+/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">

    <!-- Gritter -->
    <link href="assets/H+/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
                    ...
                    <div class="col-sm-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                            	...
                            	<p>多用户直播系统v1.0</p>                       
                            	<ul>
                            		<li><span>程序版本：</span>shtvcms v5.2 @20160818</li>
                            		<li><span>操作系统：</span>WINNT</li>
                            		<li><span>服务器软件:</span>Apache/2.4.10 (Win32) OpenSSL/0.9.8zb PHP/5.3.29</li>
                            		<li><span>PHP 版本：</span>5.3.29</li>
                            		<li><span>上传文件：</span>300M</li>
                            	</ul>
                            </div>
                        </div>
                    </div>
