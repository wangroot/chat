...
<div style="height:350px; background: url('assets/img/main-nav-bg.png');position:relative;">
	<div style="position:relative; bottom:-300px; text-align:center"><span style=" color:#FFF; font-size:40px;font-family: Microsoft YaHei;text-shadow:5px 2px 6px #000;"><?=mb_substr($cfg['config']['title'], 0, 20, 'utf-8');?>管理登录</span></div>
</div>
