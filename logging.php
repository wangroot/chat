...
switch($act){
    ...
    header("location:room/inputroom.html");
	break;
}
?>
<!doctype html>
...
<div class="logoBar w1000 m0 cf">
            ...
            <div class="oneLine cf">
                ...
                <div class="ie7LoginWidth dib cf">
                    <p class="pr">
                      ...
                      <a class="tiyan f14" href="room">游客体验</a>
                    </p>
                    <p class="pt20 cf w">
 ...
 <div id="phone_login" class="loginLeft fl h330" style="display: none;">
      <form action="?act=phonelogin" method="post" enctype="application/x-www-form-urlencoded"  name="loginform"  id="login_form" class="loginForm" onsubmit="return  validates2()" >
        <div class="loginForm">
            <div class="oneLine cf">
                <span class="itemName">手机号</span>
                <span class="star">&nbsp;</span>
                <span>
                    <input name="phone" id="phone" type="text" ></span>
            </div>
            <div class="oneLine cf">
                <span class="itemName">验证码</span>
                <span class="star">&nbsp;</span>
                <span>
                    <input name="yzm" type="text" class="yzm" id="yzm" ></span><input type="button" id="call_yzm" value="获取验证码" class="getcode text_input">
