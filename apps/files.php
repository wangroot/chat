...
<table width="100%" cellspacing="0" id="files_add" class="our"  style="margin-bottom:5px; display:none ">
          ...
          <tr>
            ...
            <button  type="button" class="button button-mini button-success" ><span id="url_bt"></span></button> <span style="color: #f46b0a">*当前服务器允许上传最大<?=ini_get('upload_max_filesize');?></span></td>
      </tr>
          <tr>
